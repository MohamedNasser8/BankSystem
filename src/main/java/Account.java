...
public class Account {
    ...
    private String ID; // unique for every account (it's const because it can't be changable)
    ...
    public Account(String accountType, double allowable) {
        ...
        debitDate = LocalDate.now();// (it's just initializing not affect the method if blocked because it's status still false
    ...
    public void withDraw(selectEventFrame frame) { // it can be int
    ...
    public void pay(selectEventFrame frame) {
        double money = 0;
    ...
    public void transferAmount(double amount, Account account, selectEventFrame frame) // it can be boolean for failed
    // operations
    {
