...
public class BankSystem {
    ...
    public boolean addAccount(String cName, String uName, String password, SignUpFrame frame) {
    ...
    public boolean openAccount(String uName, String password, LoginFrame frame) {
    ...
    public void searchForAccount(selectEventFrame frame) { // we should add exceptions here
